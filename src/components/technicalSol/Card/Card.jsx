...
const Card = ({ title, img, dec }) => {
  return (
    <div className="flex  gap-2 p-7 bg-white lg:w-full rounded shadow-md relative ">
      <div className=" flex flex-row gap-3 transition-opacity duration-300 opacity-100 hover:opacity-0">
        <Image
          src={img}
          alt="Image"
          className="w-full"
